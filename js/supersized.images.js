			jQuery(function($){
				...
				$.supersized({
					...
					slides 					:  	[			// Slideshow Images
														{image : './images/slider/image1.jpg', title : 'SPECIALISTI DELLA PROGETTAZIONE ILLUMINOTECNICA <div class="slidedescription">Se sei stanco della solita illuminazione, sei nel sito giusto. Se il tuo spazio necessita di un progetto illuminotecnico complesso, sei nel sito giusto. Se vuoi scoprire le innovazioni della domotica applicata alla progettazione illuminotecnica, sei nel sito giusto.</div>', thumb : '', url : 'http://themes.tvda.eu/'},
